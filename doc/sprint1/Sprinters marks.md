...
- Broken down into tasks/subtasks (max 2 marks)
  ...
  Your Mark: 2 (create tasks as user stories, and then create subtasks for those tasks on Jira)
...
- Estimated (max 2 marks)
  ...
  Your Mark: 1 (add point estimates on jira)
...
- Prioritized (max 2 marks)
  ...
  Your Mark: 1 (every task is given high priority in jira)
